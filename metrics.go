...
func (metrics *Metrics) IncDeadLetterReplays() {
	metrics.deadLetterReplays.Add(1)
}

func (metrics *Metrics) IncDeadLetterReplayRejected() {
	metrics.deadLetterReplayRejected.Add(1)
}
